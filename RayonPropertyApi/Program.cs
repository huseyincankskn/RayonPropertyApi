...
{
    options.AddDefaultPolicy(builder => builder.WithOrigins("https://www.rayonproperty.com", "http://www.rayonproperty.com").AllowAnyHeader().AllowAnyMethod().SetIsOriginAllowedToAllowWildcardSubdomains());
});
